...
```bash
cd /root/
./Yolo_CSIStream yolov8n_coco_640.cvimodel --cam 640x480 --stream 640x480 --uart /dev/ttyS0 --baud 115200
```
...
# Cần thêm --stream 640x480 để có thể debug/test qua python_client
APP_BIN="/root/Yolo_CSIStream"
MODEL="/root/yolov8n_coco_640.cvimodel"
ARGS="--cam 640x480 --stream 640x480 --uart /dev/ttyS0 --baud 115200"
