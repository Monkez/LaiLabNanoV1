...
const translations = {
    en: {
        ...
        form_preset: 'Use Preset',
        form_custom: 'Custom Upload',
        form_select_preset: 'Select a preset model...',
        form_model_name: 'Model Name',
        form_input_width: 'Input Width',
        form_input_height: 'Input Height',
        form_docker_container: 'Docker Container',
        form_calibration_count: 'Calibration Images',
        form_quantize: 'Quantization',
        form_processor: 'Target Processor',
        ...
        form_docker_hint: 'Container will be auto-created if not found. Image: sophgo/tpuc_dev.',

        // Pipeline
        pipeline_title: 'Conversion Pipeline',
        pipeline_empty: 'No active conversion jobs. Create a new job to get started.',
        pipeline_log_title: 'Pipeline Logs',
    ...
    vi: {
        ...
        form_preset: 'Sử dụng Preset',
        form_custom: 'Tải lên tùy chỉnh',
        form_select_preset: 'Chọn model preset...',
        form_model_name: 'Tên Model',
        form_input_width: 'Chiều rộng đầu vào',
        form_input_height: 'Chiều cao đầu vào',
        form_docker_container: 'Docker Container',
        form_calibration_count: 'Số ảnh Calibration',
        form_quantize: 'Lượng tử hóa',
        form_processor: 'Bộ xử lý đích',
        ...
        form_advanced: 'Cài đặt nâng cao',
        form_docker_hint: 'Container sẽ được tự động tạo nếu chưa có. Image: sophgo/tpuc_dev.',

        // Pipeline
        pipeline_title: 'Pipeline Chuyển đổi',
        pipeline_empty: 'Không có job chuyển đổi nào. Tạo job mới để bắt đầu.',
        pipeline_log_title: 'Log Pipeline',
